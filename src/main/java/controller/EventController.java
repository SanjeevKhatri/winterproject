...
public class EventController {
	...
	public String addEventUser(@RequestParam("user") String[] userName, Model model,
	...
	/*
	 * @RequestMapping(value = "/addEventItem", method = RequestMethod.POST)
	 * public String addEventDetail(@RequestParam("eventId")int
	 * eventId, @RequestParam("name")String name, @RequestParam("price")double
	 * price, Model model) { items.add(new Item(name,price));
	 * System.out.println(eventId); model.addAttribute("items", items); return
	 * "redirect:/eventDetail/"+eventId;
	 * 
	 * }
	 */
