			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						<!--------------------------------------------------------------------->
						<p>
							${latestItem.id } ${latestItem.name } ${latestItem.price } 
							<hr>
							<a href=" <c:url value='/updateitem/${latestItem.id}' />">Update</a>
							<a href=" <c:url value='/deleteitem/${latestItem.id}' />">Delete</a>
						</p>
						<!--------------------------------------------------------------------->
